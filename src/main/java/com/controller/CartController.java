    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(cart !=null){
            ...
            BeanUtils.copyProperties( cart , view );//把实体数据重构到view中
                ...
                //级联表
                ShujigoumaiEntity shujigoumai = shujigoumaiService.selectById(cart.getShujigoumaiId());
                if(shujigoumai != null){
    ...
    */
    ...
    public R save(@RequestBody CartEntity cart, HttpServletRequest request){
        ...
        Wrapper<CartEntity> queryWrapper = new EntityWrapper<CartEntity>()
            ...
            .eq("shujigoumai_id", cart.getShujigoumaiId())
...
//                            cartEntity.setShujigoumaiId(Integer.valueOf(data.get(0)));   //书籍 要改的
