...
public class ShujigoumaiCommentbackEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShujigoumaiCommentbackEntity() {

	}

	public ShujigoumaiCommentbackEntity(T t) {
		try {
     ...
     * 评价内容
     */
    @TableField(value = "shujigoumai_commentback_text")
    ...
    public String toString() {
        return "ShujigoumaiCommentback{" +
            "id=" + id +
            ", shujigoumaiId=" + shujigoumaiId +
            ", yonghuId=" + yonghuId +
            ", shujigoumaiCommentbackText=" + shujigoumaiCommentbackText +
            ", replyText=" + replyText +
