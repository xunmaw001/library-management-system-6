...
public class ShujigoumaiCommentbackView extends ShujigoumaiCommentbackEntity implements Serializable {
	...
	public ShujigoumaiCommentbackView() {

	}

	public ShujigoumaiCommentbackView(ShujigoumaiCommentbackEntity shujigoumaiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, shujigoumaiCommentbackEntity);
