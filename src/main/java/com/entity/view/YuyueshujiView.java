...
public class YuyueshujiView extends YuyueshujiEntity implements Serializable {
	...
	public YuyueshujiView() {

	}

	public YuyueshujiView(YuyueshujiEntity yuyueshujiEntity) {
		try {
			BeanUtils.copyProperties(this, yuyueshujiEntity);
