...
public class JuanzengshujiView extends JuanzengshujiEntity implements Serializable {
	...
	public JuanzengshujiView() {

	}

	public JuanzengshujiView(JuanzengshujiEntity juanzengshujiEntity) {
		try {
			BeanUtils.copyProperties(this, juanzengshujiEntity);
