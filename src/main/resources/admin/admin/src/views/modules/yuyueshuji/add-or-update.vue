    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍名称" prop="yuyueshujiName">
                       <el-input v-model="ruleForm.yuyueshujiName"
                                 placeholder="书籍名称" clearable  :readonly="ro.yuyueshujiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="书籍名称" prop="yuyueshujiName">
                           <el-input v-model="ruleForm.yuyueshujiName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍作者" prop="yuyueshujiZuozhe">
                       <el-input v-model="ruleForm.yuyueshujiZuozhe"
                                 placeholder="书籍作者" clearable  :readonly="ro.yuyueshujiZuozhe"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="书籍作者" prop="yuyueshujiZuozhe">
                           <el-input v-model="ruleForm.yuyueshujiZuozhe"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出版社" prop="yuyueshujiChubanshe">
                       <el-input v-model="ruleForm.yuyueshujiChubanshe"
                                 placeholder="出版社" clearable  :readonly="ro.yuyueshujiChubanshe"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="出版社" prop="yuyueshujiChubanshe">
                           <el-input v-model="ruleForm.yuyueshujiChubanshe"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="预约时间" prop="yuyueshujiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.yuyueshujiTime"
                                type="datetime"
                                placeholder="预约时间"
                                :disabled="ro.yuyueshujiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yuyueshujiTime" label="预约时间" prop="yuyueshujiTime">
                            <span v-html="ruleForm.yuyueshujiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yuyueshujiName: false,
                    yuyueshujiZuozhe: false,
                    yuyueshujiChubanshe: false,
                    shujigoumaiTypes: false,
                    yonghuId: false,
                    yuyueshujiTime: false,
                },
                ruleForm: {
                    yuyueshujiName: '',
                    yuyueshujiZuozhe: '',
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`yuyueshuji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yuyueshujiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
