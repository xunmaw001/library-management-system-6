    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍名称" prop="juanzengshujiName">
                       <el-input v-model="ruleForm.juanzengshujiName"
                                 placeholder="书籍名称" clearable  :readonly="ro.juanzengshujiName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="书籍名称" prop="juanzengshujiName">
                           <el-input v-model="ruleForm.juanzengshujiName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="书籍作者" prop="juanzengshujiZuozhe">
                       <el-input v-model="ruleForm.juanzengshujiZuozhe"
                                 placeholder="书籍作者" clearable  :readonly="ro.juanzengshujiZuozhe"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="书籍作者" prop="juanzengshujiZuozhe">
                           <el-input v-model="ruleForm.juanzengshujiZuozhe"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出版社" prop="juanzengshujiChubanshe">
                       <el-input v-model="ruleForm.juanzengshujiChubanshe"
                                 placeholder="出版社" clearable  :readonly="ro.juanzengshujiChubanshe"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="出版社" prop="juanzengshujiChubanshe">
                           <el-input v-model="ruleForm.juanzengshujiChubanshe"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="捐赠时间" prop="juanzengshujiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.juanzengshujiTime"
                                type="datetime"
                                placeholder="捐赠时间"
                                :disabled="ro.juanzengshujiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.juanzengshujiTime" label="捐赠时间" prop="juanzengshujiTime">
                            <span v-html="ruleForm.juanzengshujiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    juanzengshujiName: false,
                    juanzengshujiZuozhe: false,
                    juanzengshujiChubanshe: false,
                    shujigoumaiTypes: false,
                    yonghuId: false,
                    juanzengshujiTime: false,
                },
                ruleForm: {
                    juanzengshujiName: '',
                    juanzengshujiZuozhe: '',
                    juanzengshujiChubanshe: '',
                    shujigoumaiTypes: '',
                    yonghuId: '',
                    juanzengshujiTime: '',
                },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`juanzengshuji/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.juanzengshujiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
